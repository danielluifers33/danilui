...
if(info.flightInfo.origin.country === 'Colombia' && info.flightInfo.destination.country === 'Colombia'){
    ...
    const date1 = calculateTimeDifference(new Date(2024, 1, 1, 7, 15, 0, 0), hoursToAdd + .2);
    const date2 = calculateTimeDifference(new Date(2024, 1, 1, 13, 45, 0, 0), hoursToAdd + .4);
    const date3 = calculateTimeDifference(new Date(2024, 1, 1, 23, 9, 0, 0), hoursToAdd + .1);
